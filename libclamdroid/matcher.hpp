...
class MatcherController
{
    ...
    public:
        ...
        int cliScanBuff(const unsigned char *buffer,
                uint32_t length,
                uint32_t offset,
                cli_ctx *ctx,
                cli_file_t ftype,
        ...
        int cliFmapScandesc(cli_ctx *ctx,
                cli_file_t ftype,
                uint8_t ftonly,
                struct cli_matched_type **ftoffset,
                unsigned int acmode,
        ...
        int cliExpEval(cli_ctx *ctx,
                struct cli_matcher *root,
                struct cli_ac_data *acdata,
                struct cli_target_info *target_info,
                const char *hash);

        int cliCaloff(const char *offstr,
        ...
        int cliCheckfp(unsigned char *digest,
                size_t size,
                cli_ctx *ctx);

        int cliMatchMeta(cli_ctx *ctx,
                const char *fname,
                size_t fsizec,
                size_t fsizer,
                int encrypted,
        ...
        void cliTargetInfo(struct cli_target_info *info,
                unsigned int target,
                fmap_t *map);

        //static
        int lsigEval(cli_ctx *ctx,
                struct cli_matcher *root,
                struct cli_ac_data *acdata,
                struct cli_target_info *target_info,
                const char *hash,
        ...
        int32_t cliBcapiMatchicon(struct cli_bc_ctx *ctx ,
                const uint8_t *grp1,
                int32_t grp1len,
                const uint8_t *grp2,
                int32_t grp2len);
        ...
        int matcherRun(const struct cli_matcher *root,
